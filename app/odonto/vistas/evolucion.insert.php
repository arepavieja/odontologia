...
$('.insert-evolucion').validate({
	...
	submitHandler: function (form) {
		$.post('app/odonto/procesos/p.evolucion.insert.php',$('.insert-evolucion').serialize()+'&descripcion='+$('#editor1').html(),function(data){
			if(!isNaN(data)) {
...
<form class="insert-evolucion">
	<div class="form-group">
		...
		<div class="col-sm-12">
<!--
<textarea id="" cols="30" rows="5" class="form-control" style="resize:none" name="descripcion"></textarea>
-->
...
<input type="text" readonly autocomplete="off" class="form-control date-picker" data-date-format="yyyy-mm-dd" name="evol_fec" value="<?php echo date("Y-m-d"); ?>">
<div class="clearfix"></div>
<div class="space-10"></div>
<div id='suma'>  
	<div class="col-sm-4">
