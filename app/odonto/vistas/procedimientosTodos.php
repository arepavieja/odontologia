...
error_reporting(0);
$proced = $modonto->procedimientosTodos($cedrif);
?>
<script>
					...
					<td>
						<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
							...
							<?php if($d->trat_est==2 and $d->trat_status==0) { ?>
								<a class="red" href="#" onclick="modal('app/odonto/vistas/evolucion.php','trat_ide=<?php echo $d->trat_ide ?>&cedrif=<?php echo $cedrif ?>&des=<?php echo $d->diagcons_dien.$d->diagcons_parte.' '.$d->diagno_descrip ?>&diagno=<?php echo $d->diagcons_ide ?>&prec=<?php echo $d->precio ?>'); return false;">
									<i class="icon-cogs bigger-130"></i>
								</a>
							<?php } ?>
							<?php if($d->trat_est==2 and $d->trat_status==1) { ?>
								<a class="red" href="#" onclick="modal('app/odonto/vistas/evolucionVer.php','trat_ide=<?php echo $d->trat_ide ?>&cedrif=<?php echo $cedrif ?>&des=<?php echo $d->diagcons_dien.$d->diagcons_parte.' '.$d->diagno_descrip ?>&diagno=<?php echo $d->diagcons_ide ?>&prec=<?php echo $d->precio ?>'); return false;">
									<i class="icon-cogs bigger-130"></i>
								</a>
							<?php } ?>
						</div>
