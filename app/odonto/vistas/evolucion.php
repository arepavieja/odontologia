...
<div class="modal-body">
	<div class="btn-group pull-right">
		...
		<button type="button" class="btn btn-purple" onclick="load('app/odonto/vistas/evolucion.fotos.php','des=<?php echo $des ?>&trat_ide=<?php echo $trat_ide ?>&cedrif=<?php echo $cedrif ?>&diagno=<?php echo $diagno ?>&prec=<?php echo $prec ?>','.evolucion')">Fotos</button>
