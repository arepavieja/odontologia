		...
		<tbody>
			<?php if(count($diagnos)>0) { ?>
				<?php foreach($diagnos as $d) { ?>
					<tr>
						<td><?php echo $d->diagcons_dien ?></td>
						<td><?php echo $d->diagcons_parte ?></td>
						...
						<td>
							<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
								...
								<a class="red" href="#" onclick="modal('app/odonto/vistas/procedimiento.insert.php','cedrif=<?php echo $cedrif ?>&des=<?php echo $d->diagcons_dien.'-'.$d->diagcons_parte.' - '.$d->diagno_descrip ?>&diagcons=<?php echo $d->diagcons_ide ?>&diagno=<?php echo $d->diagno_codigo ?>'); return false;">
									<i class="fa fa-plus-square-o bigger-130"></i>
								</a>

								<a class="red" href="#" onclick="load('app/odonto/vistas/procedimientos.php','cedrif=<?php echo $cedrif ?>&des=<?php echo $d->diagcons_dien.'-'.$d->diagcons_parte.' - '.$d->diagno_descrip ?>&diagno=<?php echo $d->diagcons_ide ?>','#procedimientos'); return false;">
