	...
	$(function(){
		...
		$('.buscar-cedula').validate({
			...
			invalidHandler: function (event, validator) { 
				$('.alert-danger', $('.buscar-cedula')).show();
			},			
				...
				$.post('app/historia/procesos/p.cedula.buscar.php','nac='+nac+'&ced='+ced,function(data){
					if(data==1) {
						$.post('app/historia/procesos/p.cedula.existe.php','cedrif='+cedrif,function(data2){
							if(data2==1) {
								$.post('app/historia/procesos/p.ortodoncia.comprobar.historia.php','cedrif='+cedrif,function(data3){
									if(data3==1) {
										load('app/historia/vistas/ortodoncia.historia.php','cedrif='+cedrif,'#historia')
									}
								})
							} else {
								load('app/historia/vistas/ortodoncia.historia.insert.php','cedrif='+cedrif,'#historia');
							}
						})
					} else {
...
<div id="breadcrumbs" class="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active"> Historia Ortodoncia</li>
	</ul>
</div>
...
<div class="col-xs-6 ">
	<div class="msj"></div>
	<!--<form action="" class="form-inline buscar-cedula" role="form">
			<div class="form-group">
				<label><strong>Cédula de Identidad:</strong></label>
