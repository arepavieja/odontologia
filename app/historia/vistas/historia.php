...
<script>
	$(function(){
		$('.fecha').datepicker();
		load('app/historia/vistas/consulta.php','cedrif=<?php echo $cedrif ?>','#modulos')
		/**
...
<div class="pull-left">
	<div class="foto pull-left" style="margin-right:132px" onclick="modal('app/historia/vistas/foto.update.php','cedrif=<?php echo $cedrif ?>')">
		...
		<input class="input-small" type="text" disabled value="<?php echo sprintf('%03d',$datospers_rows[0]->pacien_nro_histo) ?>">

</div>
<div class="pull-right">
	<div class="btn-group nav-paciente">

		<button class="btn btn-sm btn-success modulos" data-toggle="dropdown"  onclick="load('app/historia/vistas/consulta.php','cedrif=<?php echo $cedrif ?>','#modulos')"><i class="fa fa-user-md"> Consulta</i>
		</button>
